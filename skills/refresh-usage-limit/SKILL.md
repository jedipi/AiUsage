...
The shared cache is `%LOCALAPPDATA%\AiUsage\usage.json`. The Antigravity adapter maps weekly `quota` buckets to Gemini and Claude/GPT model pools, ignores five-hour buckets, and does not read authentication files, prompts, responses, or transcripts.
